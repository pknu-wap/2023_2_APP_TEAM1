...
protocol CalViewControllerDelegate: AnyObject {
    func didAppendUserInfo(_ userInfo: [String])
}

class CalViewController: UIViewController, UITextFieldDelegate {
    
    weak var delegate: CalViewControllerDelegate?
